        ...
        <div className="grid lg:grid-cols-5 gap-16">
          ...
          <div className="lg:col-span-3">
            <form
              ...
              className="bg-black border border-white/5 p-8 md:p-12 rounded-[2.5rem] relative overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.5)]"
            >
              ...
              >
                <option value="" disabled>Select Preferred SAP Module *</option>
...
export function CanvasRevealWrapper({
  mainContent,
  contactContent
}: {
