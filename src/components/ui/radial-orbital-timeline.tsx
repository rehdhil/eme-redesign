...
export default function RadialOrbitalTimeline({
    ...
    const [orbitRadius, setOrbitRadius] = useState<number>(280);
    ...
    return (
        <div
            className="w-full h-[500px] md:h-[650px] lg:h-[800px] flex flex-col items-center justify-center bg-black overflow-hidden relative"
            ref={containerRef}
        ...
        >
            <div className="relative w-full max-w-5xl h-full flex items-center justify-center">
                ...
                >
                  ...
                  ${isExpanded ? (isMobile ? "scale-125" : "scale-[1.6]") : "hover:scale-110"}
                `}
                                >
                                ...
                                <div
                                    className={`
                  absolute top-12 md:top-16 whitespace-nowrap
                  text-[10px] md:text-sm lg:text-base font-semibold tracking-wider
                  transition-all duration-300
                  ${isExpanded ? "text-white scale-110 md:scale-125 translate-y-4 md:translate-y-6" : "text-white/70"}
                ...
                `}
                                ...
                                {isExpanded && (
                                    <Card className="absolute top-20 md:top-24 left-1/2 -translate-x-1/2 w-[280px] md:w-80 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible z-50">
                                        ...
                                        <CardHeader className="pb-2 p-4 md:p-5">
                                            ...
                                            <CardTitle className="text-base md:text-lg mt-2 font-bold text-white">
                                                {item.title}
                                            </CardTitle>
                                        </CardHeader>
                                        <CardContent className="text-xs md:text-sm text-white/80 p-4 pt-0 md:p-5 md:pt-0">
                                            ...
                                            <div className="mt-4 pt-3 border-t border-white/10">
                                                ...
                                                <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                                                    <div
                                                        className="h-full bg-gradient-to-r from-brand-blue to-teal-400"
                                                    ...
                                                    <div className="flex flex-wrap gap-1">
                                                        {item.relatedIds.map((relatedId) => {
                                                            ...
                                                            return (
                                                                <button
                                                                    key={relatedId}
                                                                    className="flex items-center h-6 px-2 py-0 text-[10px] rounded border border-white/20 bg-transparent hover:bg-white/10 text-white/80 hover:text-white transition-all"
                                                                    onClick={(e) => {
                                                                        e.stopPropagation();
